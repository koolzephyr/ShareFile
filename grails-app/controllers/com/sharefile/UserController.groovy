...
class UserController {
    ...
    def list(Integer max) {
        ...
        [userInstanceList: User.list(params), userRoleInstanceList: SecUserSecRole.list(params), userInstanceTotal: User.count()]
    }
    ...
    def show(Long id) {
        ...
        def userRoleInstance = SecUserSecRole.findBySecUser(userInstance)
    ...
    def delete(Long id) {
        def userInstance = User.get(id)
        def userRoleInstance = SecUserSecRole.get(id)
        if (!userInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'user.label', default: 'User'), id])
            redirect(action: "list")
            return
